  ...
  const eventDetails = [
    {
      icon: '⏳',
      title: 'Duration',
      value: '24 Hours Hackathon',
      delay: 0.2
    },
    {
      icon: '📍',
      title: 'Venue',
      value: 'VRSEC IT Seminar Hall',
      delay: 0.4
    },
    {
      icon: '👥',
    ...
    },
    {
      icon: '🍔',
      title: 'Food & Snacks',
      value: 'Full meals and snacks provided',
      delay: 0.8
    },
    {
      icon: '🏆',
      title: 'Prizes',
      value: '1st – ₹15,000, 2nd – ₹10,000, 3rd – ₹5,000',
      delay: 1.0
    },
    {
      icon: '🎁',
      title: 'Perks',
      value: 'Swags, Exciting Gifts, Certificates',
      delay: 1.2
    }
  ];

  return (
    <div className="min-h-screen bg-transparent relative overflow-hidden py-20 px-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Event Details - Professional Zigzag Layout */}
<div className="max-w-6xl mx-auto mb-16">
  <div className="space-y-12">
    
    {/* Duration - Left Side */}
    <div className={`flex items-center justify-start transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`} style={{ transitionDelay: '0.8s' }}>
      <div className="group relative max-w-md">
        <div className="p-6 bg-transparent backdrop-blur-sm border border-green-400/30 rounded-xl hover:border-green-400/60 transition-all duration-500 hover:bg-green-400/5"
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-green-300 mb-1" style={{ fontFamily: '"Orbitron", monospace' }}>24-Hour Hackathon</h3>
              <p className="text-white/80 text-sm">Non-stop coding marathon</p>
            </div>
          </div>
        </div>
      </div>
    ...
    {/* Team Size - Right Side */}
    <div className={`flex items-center justify-end transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`} style={{ transitionDelay: '1.0s' }}>
      <div className="group relative max-w-md">
        <div className="p-6 bg-transparent backdrop-blur-sm border border-green-400/30 rounded-xl hover:border-green-400/60 transition-all duration-500 hover:bg-green-400/5"
             onMouseEnter={(e) => {
               e.target.style.transform = 'translateX(-10px)';
          ...
          <div className="flex items-center space-x-4">
            <div className="text-4xl">👥</div>
            <div>
              <h3 className="text-xl font-bold text-green-300 mb-1" style={{ fontFamily: '"Orbitron", monospace' }}>2-4 Member Teams</h3>
              <p className="text-white/80 text-sm">Collaborative innovation</p>
            </div>
          </div>
        </div>
      </div>
    ...
    {/* Food - Left Side */}
    <div className={`flex items-center justify-start transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-20 opacity-0'}`} style={{ transitionDelay: '1.2s' }}>
      <div className="group relative max-w-md">
        <div className="p-6 bg-transparent backdrop-blur-sm border border-green-400/30 rounded-xl hover:border-green-400/60 transition-all duration-500 hover:bg-green-400/5"
             onMouseEnter={(e) => {
               e.target.style.transform = 'translateX(10px)';
          ...
          <div className="flex items-center space-x-4">
            <div className="text-4xl">🍔</div>
            <div>
              <h3 className="text-xl font-bold text-green-300 mb-1" style={{ fontFamily: '"Orbitron", monospace' }}>Full Meals Provided</h3>
              <p className="text-white/80 text-sm">Breakfast, lunch & snacks</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className={`flex items-center justify-end transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}`} style={{ transitionDelay: '1.4s' }}>
      <div className="group relative max-w-md">
        <div className="p-6 bg-transparent backdrop-blur-sm border border-green-400/30 rounded-xl hover:border-green-400/60 transition-all duration-500 hover:bg-green-400/5"
             onMouseEnter={(e) => {
               e.target.style.transform = 'translateX(-10px)';
          ...
          <div className="flex items-center space-x-4">
            <div className="text-4xl">🎁</div>
            <div>
              <h3 className="text-xl font-bold text-green-300 mb-1" style={{ fontFamily: '"Orbitron", monospace' }}>Certificates & Swags</h3>
              <p className="text-white/80 text-sm">Recognition for participation</p>
            </div>
          </div>
        </div>
      </div>
