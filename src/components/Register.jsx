...
const RegistrationComponent = () => {
  ...
  const whatsappGroupLink = 'https://chat.whatsapp.com/JgbMinWTnaRG30yGSJP5f0?mode=ems_share_t';
          ...
          <div className={`bg-transparent border-2 rounded-xl p-8 shadow-2xl max-w-md w-full ${
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-3 pt-4">
                {/* WhatsApp Group Button - Only show for successful registration */}
                {messageType === 'success' && (
                  <button
                    onClick={handleWhatsAppJoin}
                    className="w-full bg-transparent border-2 border-green-500/60 text-green-400 hover:bg-green-500/10 hover:border-green-500 hover:text-green-300 font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-green-500/30 flex items-center justify-center space-x-2"
                  >
