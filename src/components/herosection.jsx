        ...
        <div className="w-full px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col items-center justify-center text-center space-y-2 sm:space-y-3">
            <div className="flex items-center justify-center">
              <span className="text-green-400 font-semibold text-sm sm:text-base">ANNOUNCEMENTS</span>
              <span className="text-red-400 ml-2">📢</span>
            </div>
            <div className="text-gray-300 text-xs sm:text-sm max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-1 sm:gap-4 mt-1">
                <span>
